...
export type ProfileRow = {
  ...
  undergraduate_field_of_study: string | null;
  ...
  email_deadline_reminders: boolean | null;
  ...
  // Live column is boolean (older code wrote affirmative strings, which
  // Postgres coerced); readers accept both shapes.
